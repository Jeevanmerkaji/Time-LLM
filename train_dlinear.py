"""
Training script for the DLinear baseline (see dlinear_baseline.py).

Example:
    python train_dlinear.py --csv data/electric_motor_temp_profile70.csv \
...
from dlinear_baseline import DLinear
...
def main():
    ...
    ap.add_argument("--kernel_size", type=int, default=25)
    ap.add_argument("--batch_size", type=int, default=16)
    ap.add_argument("--epochs", type=int, default=30)
    ap.add_argument("--lr", type=float, default=1e-3)
    ap.add_argument("--save_path", type=str, default="checkpoints/dlinear_baseline.pt")
    ...
    model = DLinear(
        seq_len=args.seq_len, pred_len=args.pred_len, kernel_size=args.kernel_size,
    ).to(device)
